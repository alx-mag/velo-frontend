ymaps.modules.define("Heatmap", ["option.Manager", "Monitor", "Layer", "heatmap.component.dataConverter", "heatmap.component.TileUrlsGenerator"], function(a, b, c, d, e, f) {
    ...
    g.prototype.getData = function() {
        ...
        g.prototype.setData = function(a) {
            this._data = a;
            var b = e.convert(a);
            return this._tileUrlsGenerator ? (this._tileUrlsGenerator.setPoints(b),
                this._refresh()) : this._unprocessedPoints = b,
                this
        }
        ,
        ...
        g.prototype.setMap = function(a) {
            return this._map != a && (this._layer && (this._map.layers.remove(this._layer),
                this._destroyLayer()),
                this._map = a,
            a && (this._setupLayer(),
        ...
        g.prototype._refresh = function() {
            return this._layer && this._layer.update(),
                this
        }
        ,
        ...
        g.prototype._setupTileUrlsGenerator = function() {
            return this._tileUrlsGenerator = new f(this._map.options.get("projection"),this._unprocessedPoints),
        ...
        g.prototype._setupOptionMonitor = function() {
            return this._optionMonitor = new c(this.options),
                this._optionMonitor.add(["radius", "dissipating", "opacity", "intensityOfMidpoint", "gradient"], this._refresh, this)
        }
        ,
        ...
        h.prototype.setPoints = function(a) {
            ...
            for (var b = [], c = 0, d = a.length; d > c; c++)
                this._points.push({
                    ...
                    b.push(a[c].weight);
            return this._canvas.options.set("medianaOfWeights", e(b)),
                this
        }
            ,
            ...
            h.prototype.getTileUrl = function(a, b) {
                ...
                if (this.options.get("dissipating")) {
                    ...
                    c && this._canvas.options.unset("radiusFactor");
                for (var f, h = Math.pow(2, b), i = [[a[0] * g[0] / h, a[1] * g[1] / h], [(a[0] + 1) * g[0] / h, (a[1] + 1) * g[1] / h]], j = this._canvas.getBrushRadius() / h, k = [], l = 0, m = this._points.length; m > l; l++)
                    f = this._points[l].coordinates,
                    this._contains(i, f, j) && k.push({
    ...
    ymaps.modules.define("heatmap.component.Canvas", ["option.Manager", "Monitor"], function(a, b, c) {
        ...
        e.prototype.getBrushRadius = function() {
            return this.options.get("radius", d.radius) * this.options.get("radiusFactor", d.radiusFactor)
        }
            ,
            e.prototype.generateDataURLHeatmap = function(a) {
                return this._drawHeatmap(a || []),
            ...
            ,
            e.prototype._setupOptionMonitor = function() {
                return this._optionMonitor = new c(this.options),
                    this._optionMonitor.add(["radius", "radiusFactor", "gradient"], this._setupDrawTools, this)
            }
            ,
            e.prototype._destroyOptionMonitor = function() {
                this._optionMonitor.removeAll(),
                    this._optionMonitor = {}
            }
            ,
            e.prototype._setupDrawTools = function() {
                return this._brush = this._createBrush(),
                    this._gradient = this._createGradient(),
                    this
            }
            ,
            e.prototype._destroyDrawTools = function() {
                this._brush = null,
                    this._gradient = null
            }
            ,
            e.prototype._createBrush = function() {
            ...
            ,
            e.prototype._createGradient = function() {
                var a = document.createElement("canvas")
                    , b = a.getContext("2d")
                ...
                for (var f in e)
                    e.hasOwnProperty(f) && c.addColorStop(f, e[f]);
                return b.fillStyle = c,
                    b.fillRect(0, 0, 1, 256),
                    b.getImageData(0, 0, 1, 256).data
            }
            ,
            e.prototype._drawHeatmap = function(a) {
                var b = this._context
                    , c = this.getBrushRadius()
                ...
                return this._colorize(j.data),
                    b.putImageData(j, 0, 0),
                    this
            }
            ,
            e.prototype._colorize = function(a) {
